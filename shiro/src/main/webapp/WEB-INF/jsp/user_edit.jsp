...
<section class="rt_wrap content mCustomScrollbar">
 <div class="crumb"><span class="dq"><img src="${ctxPath }/images/home.png" style="width:20px;margin-top:-2px;"></span><span class="dq">编辑用户</span></div>
      ...
      <form method="post">
	      <ul class="ulColumn2">
	       <li>
	        ...
	        <input type="text" class="textbox textbox_295" name="username" id="username" value="${user.username }"/>
	       </li>
	       <li>
	        <span class="item_name" style="width:120px;">密码：</span>
	        <input type="password" class="textbox textbox_295" name="password" id="password" value="${user.password }"/>
	       </li>
	        <li>
	        ...
	        <tr><td>
	        	<s:iterator value="#request.roleList" id="role">
	        		<input type="checkbox" name="roleId" value="${role.id }"
	        			<s:iterator value="#request.myRoles" id="mr">
	        				<s:if test="#role.id == #mr.id">checked</s:if>
	        			</s:iterator>
	        		> ${role.name }<br><br>
	        	</s:iterator>
	        </td></tr>
	       ...
	       <li>
	        ...
	        <input type="submit" id="submit" class="link_btn" value="提交"/>
	       </li>
...
$(document).ready(function() {
  $("#submit").click(function(e){
	  ...
	  var formData = {'id':$('#id').val(),'username':$('#username').val(), 'password':$('#password').val(), 'roleIds':roleIds};
	  $.post("${ctxPath }/user_update", formData, function(data){
